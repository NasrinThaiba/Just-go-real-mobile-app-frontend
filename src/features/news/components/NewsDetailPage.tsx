...
import {
  BookmarkButton,
} from '@/components/interactions/BookmarkButton';

import {
  CommentButton,
} from '@/components/interactions/CommentButton';

import {
  FavoriteButton,
} from '@/components/interactions/FavoriteButton';

import {
  InlineComments,
} from '@/components/interactions/InlineComments';

import {
  ShareButton,
} from '@/components/interactions/ShareButton';

import {
  ErrorView,
} from '@/components/ui/ErrorView';

import {
  LoadingView,
} from '@/components/ui/LoadingView';
...
import {
  useNewsDetails,
} from '@/features/news/hooks/useNewsDetails';
    ...
    return (
      ...
      >
        ...
        <Pressable
          ...
          className="mx-5 mt-4 items-center rounded-xl bg-primary py-3"
        >
  ...
  if (item.type !== 'news') {
    ...
    return (
      ...
      >
        ...
        <ErrorView
          message="This content is not a news article."
        />
