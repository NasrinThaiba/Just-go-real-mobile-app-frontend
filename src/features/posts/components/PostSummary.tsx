...
import { PostSummaryCard } from '@/features/posts/components/PostSummaryCard';
import type { MyPostFilter } from '@/features/posts/hooks/useMyPosts';
  ...
  return (
    <>
      ...
      <Text className="mt-1 text-sm text-textMuted">
        Review your submitted news and videos.
      </Text>
