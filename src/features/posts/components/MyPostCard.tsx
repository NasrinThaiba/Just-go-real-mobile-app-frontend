  ...
  return (
    <View className="mb-4 overflow-hidden rounded-2xl border border-borderSoft bg-white">
        ...
        >
          ...
          {isVideo ? (
            <View className="absolute inset-0 items-center justify-center bg-black/20">
              <View className="h-10 w-10 items-center justify-center rounded-full bg-black/65">
                <Ionicons
                  name="play"
                  size={21}
                  color="#FFFFFF"
      ...
      <View className="flex-row">
        <View className="flex-1 flex-row items-center justify-center px-3 py-3.5">
          ...
          <Switch
            ...
            onValueChange={handlePublishSwitch}
            trackColor={{
              false: '#CBD5E1',
              true: '#86EFAC',
            }}
      ...
      {currentStatus === 'rejected' ? (
        <View className="border-t border-borderSoft bg-red-50 px-4 py-3">
          <Text className="text-xs font-semibold leading-5 text-red-700">
            This post was rejected. Edit the content and submit it again.
          </Text>
        </View>
      ) : null}

      {currentStatus === 'draft' ? (
        <View className="border-t border-borderSoft bg-blue-50 px-4 py-3">
          <Text className="text-xs font-semibold leading-5 text-blue-700">
            This post is saved as a draft and is not visible to the public.
          </Text>
        </View>
      ) : null}
    </View>
